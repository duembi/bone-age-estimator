...
Training Pipeline — RSNA Bone Age Challenge 2017

Trains 7 CNN architectures (VGG16, ResNet50, InceptionV3, DenseNet121,
EfficientNet-B0, EfficientNet-B3, Xception) under identical hyperparameters.
EfficientNet-B0 serves as the system's primary backbone; all 7 models
participate in ensemble inference (patient_predict.py).

Usage (Kaggle):
    python multi_model_train.py                    # train all models
    python multi_model_train.py --models EfficientNetB0 DenseNet121

Outputs: best_<ModelName>.pth checkpoints + history_<ModelName>.csv
"""
